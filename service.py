...
class Main:
    def __init__(self):
        ...
        # it should stop now
        # self._init_vars()
        self.WINDOW.clearProperty('TencentDataProvider_Running')
        ...
        self.WINDOW.setProperty('TencentDataProvider_Running', 'true')
        # self._daemon()
    ...
    def _daemon(self):
        ...
        count = 0
        while not self.Monitor.abortRequested() and self.WINDOW.getProperty('TencentDataProvider_Running') == 'true':

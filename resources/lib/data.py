...
def _get_data(request, usecache):
    ...
    elif request == "recommendednba":
        return LIBRARY._fetch_recommended_nba(usecache)

    elif request == "recommendedphysical":
        return LIBRARY._fetch_recommended_physical(usecache)
